...
// Heavier model for high-stakes creative work (social copy that goes public).
const OPUS_MODEL = process.env.SOCIAL_MODEL || 'claude-opus-4-6';
 ...
 * @param {string} [model]  override the default marketing model (e.g. OPUS_MODEL)
 */
async function askClaude(system, user, maxTokens = 1200, model = MODEL) {
...
module.exports = { askClaude, extractJson, configured, MODEL, OPUS_MODEL };
