 ...
 * deal's price, pick a RANDOM eligible product variant, apply a fixed 30%
 * discount and set a fresh 7-day countdown. Eligible = deal_flag + in_stock
 * (falls back to any discountable in-stock variant).
 *
