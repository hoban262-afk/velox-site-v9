...
function stage2(links) {
  const trust =
    ...
    '<tr><td style="padding:9px 0;border-bottom:1px solid #1a1a1a;font-size:13px;color:#e5e7eb">&#10003;&nbsp; <strong style="color:#fff">UK dispatch</strong> via Royal Mail Tracked 24 from Northern Ireland</td></tr>' +
...
function stage3(links) {
  ...
  const body =
    emailParagraph(hasCode
      ? 'You joined the Velox research community but haven&rsquo;t placed your first order yet. Your 10% code won&rsquo;t last forever, so here it is one more time.'
