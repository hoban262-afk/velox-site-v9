...
function stage2(links) {
  const trust =
    ...
    '<tr><td style="padding:9px 0;border-bottom:1px solid #1a1a1a;font-size:13px;color:#e5e7eb">&#10003;&nbsp; <strong style="color:#fff">CoA supplied</strong> &mdash; purity &amp; mass-spec on file</td></tr>' +
    '<tr><td style="padding:9px 0;border-bottom:1px solid #1a1a1a;font-size:13px;color:#e5e7eb">&#10003;&nbsp; <strong style="color:#fff">UK dispatch</strong> &mdash; Royal Mail Tracked 24 from Northern Ireland</td></tr>' +
    '<tr><td style="padding:9px 0;font-size:13px;color:#e5e7eb">&#10003;&nbsp; <strong style="color:#fff">Pay by Bank</strong> &mdash; card details never stored</td></tr>' +
    '</table>';
  const body =
    emailParagraph('The research-peptide market is full of unverified product. We built Velox to be the opposite &mdash; every batch is independently HPLC-tested with a batch-specific Certificate of Analysis you can actually read.') +
    trust +
