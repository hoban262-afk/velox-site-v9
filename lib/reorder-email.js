...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="${S.card}">
  ...
  <tr><td align="center" style="padding:0 40px 22px">
    <p style="margin:0;font-size:15px;color:#888;line-height:1.7">
      Hi ${fn}, it's been about a month since your last order with us. If your supply of ${prod} is running low, I've made it easy to reload your previous order into your basket - one tap and you're at checkout.
    </p>
  </td></tr>
