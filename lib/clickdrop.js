...
// endpoint 404, empty 200, changed response shape) instead of a silent []. Encodes
// each identifier individually and joins with RAW commas — encoding the whole
// comma-joined string turns the separators into %2C, which Royal Mail rejects.
