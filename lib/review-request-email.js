...
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Leave a review</title></head>
<body style="${S.body}">
...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="${S.card}">
  ...
  <tr><td align="center" style="padding:0 40px 22px">
    <p style="margin:0;font-size:15px;color:#888;line-height:1.7">
      Hi ${fn}, thanks for your recent order with Velox. If you have a minute, a short review of <strong style="color:#fff">${name}</strong> &mdash; purity, documentation, dispatch speed, or your experience ordering &mdash; would genuinely help other researchers choose with confidence.
    </p>
  </td></tr>
  ...
  <tr><td style="padding:0 40px 20px">
    <p style="margin:0;font-size:13px;color:#888;line-height:1.7">
      It takes about a minute and no account is needed. Anything we could do better? Just reply to this email &mdash; it comes straight to me.
    </p>
  </td></tr>
