  ...
  switch (stage) {
    case 1:
      return {
        ...
        intro:   `Hi ${fn}, it looks like your payment didn't finish - sometimes the bank approval step gets interrupted on the way back to the site. It happens, and it's an easy fix. Your basket is saved below.`,
        extra:   `<p style="margin:0 0 10px;font-size:13px;color:#888;line-height:1.7">
                    Pay-by-Bank takes about <strong style="color:#fff">30 seconds</strong> - a direct, secure bank transfer with no card details to enter.
    ...
    case 2:
      return {
        ...
        extra:   `<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:2px 0 4px">
                    ...
                    <tr><td style="font-size:13px;color:#888;padding:5px 0;line-height:1.6">&#10003;&nbsp; <strong style="color:#fff">UK dispatch</strong> - same or next day, Royal Mail Tracked 24, full tracking emailed.</td></tr>
                    <tr><td style="font-size:13px;color:#888;padding:5px 0;line-height:1.6">&#10003;&nbsp; <strong style="color:#fff">A real person on support</strong> - reply to this email any time and you'll get me, not a bot.</td></tr>
                  </table>`,
      };
    case 3:
    default: {
      ...
      const codeBlock = code ? `
                  <div style="background:#030407;border:1px solid rgba(1,211,160,.35);border-radius:10px;padding:18px 20px;text-align:center;margin:2px 0 4px">
                    <div style="font-size:11px;color:#6B7280;letter-spacing:.12em;text-transform:uppercase;margin-bottom:6px">15% off - just for you</div>
      ...
      return {
        ...
        intro:   code
          ? `Hi ${fn}, this is the last reminder I'll send about this one. To make it easy, here's <strong style="color:#fff">15% off</strong> your saved basket - a one-time code, just for you. If now isn't the right time, no problem at all; everything stays available whenever your research needs it.`
          : `Hi ${fn}, this is the last reminder I'll send about this one - after today I'll clear the saved basket so stock frees up for other researchers. If now isn't the right time, no problem at all; everything stays available to order whenever your project needs it.`,
        extra:   codeBlock,
      };
    }
  }
