...
(function () {
  ...
  css.textContent = [
    '.vp-ship-nudge{display:flex;align-items:center;gap:10px;margin:0 0 14px;font-size:12.5px;color:#9CA3AF;background:rgba(22,214,166,.06);border:1px solid rgba(22,214,166,.22);border-radius:8px;padding:9px 12px;line-height:1.4}',
    '.vp-ship-nudge b{color:#16d6a6;font-weight:600}',
    '.vp-vol-nudge{display:block;margin:0 0 14px;font-size:12.5px;color:#9CA3AF;background:rgba(22,214,166,.06);border:1px solid rgba(22,214,166,.22);border-radius:8px;padding:10px 14px;line-height:1.4}',
    '.vp-vol-nudge b{color:#16d6a6;font-weight:600}',
    '.vp-vol-track{position:relative;height:6px;margin:15px 18px 26px;background:rgba(255,255,255,.1);border-radius:99px}',
    '.vp-vol-trackfill{position:absolute;left:0;top:0;height:100%;background:#16d6a6;border-radius:99px;width:0;transition:width .35s ease}',
    ...
    '.vp-vol-cp.hit{background:#16d6a6;border-color:#16d6a6;box-shadow:0 0 9px rgba(22,214,166,.65)}',
    ...
    '.vp-vol-cp.hit .vp-vol-cplbl{color:#16d6a6;font-weight:600}',
    '.vp-ship-nudge .vpn-bar{flex:0 0 60px;height:5px;border-radius:3px;background:rgba(255,255,255,.1);overflow:hidden}',
    '.vp-ship-nudge .vpn-fill{display:block;height:100%;background:#16d6a6;width:0;transition:width .35s ease}',
    ...
    '@media(max-width:767px){',
      ...
      '.vp-sticky-buy .vsb-btn{margin-left:auto;flex:0 0 auto;background:#16d6a6;color:#021;font-family:var(--mono,monospace);font-size:13px;font-weight:600;letter-spacing:.05em;text-transform:uppercase;border:none;border-radius:8px;padding:13px 22px;cursor:pointer}',
