...
(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      '.vlxc-full{font-size:12.5px;font-weight:700;color:#16d6a6;text-decoration:none;white-space:nowrap;}',
      ...
      '.vlxc-price{font-family:"Barlow Condensed",sans-serif;font-weight:900;font-size:20px;color:#16d6a6;}',
      '.vlxc-buy{font-weight:700;font-size:12px;color:#16d6a6;text-decoration:none;margin-left:6px;}',
      '.vlxc-ns{color:#8aa0a0;}.vlxc-ns a{color:#16d6a6;text-decoration:none;}',
