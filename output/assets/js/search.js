...
(function () {
  ...
  css.textContent = [
    ...
    '.vp-search-input:focus{outline:none;border-color:#16d6a6;box-shadow:0 0 0 3px rgba(22,214,166,.15)}',
    ...
    '.vp-sr-item:hover,.vp-sr-item.is-active{background:rgba(22,214,166,.08)}',
    ...
    '.vp-sr-badge.product{color:#16d6a6;border-color:rgba(22,214,166,.3)}',
    ...
    '.vp-sr-all{display:block;padding:11px 16px;text-align:center;font-family:var(--mono,monospace);font-size:11px;letter-spacing:.05em;text-transform:uppercase;color:#16d6a6;text-decoration:none;border-top:1px solid rgba(255,255,255,.08);background:rgba(22,214,166,.04)}',
    /* prominent hero variant */
    '.vp-search-hero{max-width:none}',
    '.vp-search-label{font-family:var(--mono,monospace);font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#16d6a6;margin-bottom:10px;display:flex;align-items:center;gap:8px}',
    '.vp-search-label::before{content:"";width:18px;height:1px;background:#16d6a6}',
    '.vp-search-hero .vp-search-input{font-size:16px;padding:17px 116px 17px 50px;border-color:rgba(22,214,166,.4);background:#0c0c0c}',
    '.vp-search-hero .vp-search-box svg{left:18px;width:20px;height:20px;stroke:#16d6a6}',
    '.vp-search-btn{position:absolute;right:6px;top:6px;bottom:6px;border:none;border-radius:8px;background:#16d6a6;color:#021;font-family:var(--mono,monospace);font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;padding:0 20px;cursor:pointer;transition:background .15s}',
    ...
    '.vp-search-nav .vp-search-input:focus{background:#0f0f0f;border-color:#16d6a6;}',
