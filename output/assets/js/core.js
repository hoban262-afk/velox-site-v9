  ...
  try {
    ...
    var css = [
      ...
      '@media(max-width:767px){',
        ...
        '#vpdock .vpd-msg b{color:#16d6a6;font-weight:700}',
        '#vpdock .vpd-track{position:relative;height:5px;margin:0 22px 13px;background:rgba(255,255,255,.1);border-radius:99px}',
        '#vpdock .vpd-fill{position:absolute;left:0;top:0;height:100%;background:#16d6a6;border-radius:99px;width:0;transition:width .35s ease}',
        ...
        '#vpdock .vpd-cp.hit{background:#16d6a6;border-color:#16d6a6;box-shadow:0 0 7px rgba(22,214,166,.6)}',
        ...
        '#vpdock .vpd-cp.hit .vpd-cplbl{color:#16d6a6;font-weight:600}',
        ...
        '#vpdock .vpd-tab.active{color:#16d6a6}',
        '#vpdock .vpd-tab svg{width:22px;height:22px}',
        '#vpdock .vpd-badge{position:absolute;top:2px;left:calc(50% + 7px);min-width:16px;height:16px;padding:0 4px;border-radius:99px;background:#16d6a6;color:#021;font:800 9px/16px Inter,Arial,sans-serif;text-align:center}',
