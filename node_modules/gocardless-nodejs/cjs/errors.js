...
class ApiError extends GoCardlessException {
    ...
    static buildFromResponse(response) {
        ...
        try {
            ...
            const error = body === null || body === void 0 ? void 0 : body.error;
            ...
            const failureResponse = {
                ...
                body: {
                    error: {
                        ...
                        type: 'gocardless',
                        request_id: (_d = (_c = response === null || response === void 0 ? void 0 : response.headers) === null || _c === void 0 ? void 0 : _c['x-request-id']) !== null && _d !== void 0 ? _d : null,
                        code: 500,
                    },
                },
            };
