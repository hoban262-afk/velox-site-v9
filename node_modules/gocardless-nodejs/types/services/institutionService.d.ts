...
export declare class InstitutionService {
    ...
    list_for_billing_request(identity: string, requestParameters: InstitutionListForBillingRequestRequest, customHeaders?: Types.JsonMap): Promise<InstitutionListResponse>;
}
export {};
